...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --Base-color: #36b37e;\n  --Accent-color: #ffc400;\n  --Background-color: #f3f5f7;\n  --Secondary-bg-color: #ffffff;\n  --Text-color: #333f50;\n  --Secondary-text-color: #9b9b9b;\n  --add-btn-color: #2d4acd;\n  --add-btn-hover: hsl(229, 80%, 30%);\n  --top-priority: #ef4040;\n  --medium-priority: #f08935;\n\n  --top-bottom-padding: 16px;\n  --right-left-padding: 16px;\n}\n\n*,\n*::before,\n*::after {\n  margin: 0;\n  box-sizing: border-box;\n}\n\nbody {\n  min-height: 100vh;\n  display: grid;\n  grid-template-rows: auto 1fr auto;\n  color: var(--Text-color);\n  position: relative;\n}\n\nheader {\n  background-color: var(--Base-color);\n  color: var(--Accent-color);\n  padding-block: var(--top-bottom-padding);\n  padding-inline: var(--right-left-padding);\n}\n\nh1 img {\n  width: 30px;\n  height: 28px;\n  vertical-align: middle;\n  color: var(--Accent-color);\n}\n\nmain {\n  background-color: var(--Background-color);\n}\n\nmain .content {\n  min-height: 100%;\n  display: grid;\n  grid-template-columns: minmax(120px, 20%) 1fr;\n  grid-template-rows: 1fr;\n  padding-left: var(--right-left-padding);\n}\n\nmain .side-bar {\n  padding-block: var(--top-bottom-padding);\n}\n\n.side-bar .wrapper {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 8px;\n  margin-bottom: var(--top-bottom-padding);\n  margin-right: var(--right-left-padding);\n  border-radius: 10px;\n  cursor: pointer;\n}\n\n.side-bar .wrapper:hover {\n  background-color: var(--Secondary-bg-color);\n}\n.side-bar .wrapper.active {\n  background-color: var(--Secondary-bg-color);\n}\n\n.side-bar #add-project {\n  background-color: var(--add-btn-color);\n  color: var(--Secondary-bg-color);\n  width: 60%;\n  font-weight: 600;\n}\n\n.side-bar #add-project:is(:hover, :focus) {\n  background-color: var(--add-btn-hover);\n}\n\n.wrapper h2 {\n  font-size: 18px;\n}\n\n.wrapper img {\n  width: 20px;\n  height: 20px;\n}\n\n/* close icon */\n.wrapper .close-icon {\n  margin-left: auto;\n}\n\n.projects h2 {\n  margin-bottom: var(--top-bottom-padding);\n}\n\nmain .main-content {\n  background-color: var(--Secondary-bg-color);\n  display: grid;\n  place-items: center;\n}\n\n.main-content .container {\n  width: 90%;\n  height: 90%;\n  margin-bottom: 32px;\n}\n\n.container .add-task {\n  background-color: var(--add-btn-color);\n  color: var(--Background-color);\n  font-size: 14px;\n  margin-block: 16px;\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  max-width: fit-content;\n  padding: 8px;\n  border-radius: 12px;\n  cursor: pointer;\n}\n\n.container .add-task:is(:hover, :focus) {\n  background-color: var(--add-btn-hover);\n}\n\n.container .add-task img {\n  width: 15px;\n  height: 15px;\n}\n\nfooter {\n  text-align: center;\n  padding-block: var(--top-bottom-padding);\n  padding-inline: var(--right-left-padding);\n  background-color: var(--Base-color);\n  color: var(--Accent-color);\n}\n\nfooter a {\n  color: inherit;\n}\n\n.modal,\n.task-modal,\n.update-task-modal {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  z-index: 9999;\n  background-color: var(--Base-color);\n  color: var(--Background-color);\n  padding: 16px 32px;\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n  border-radius: 12px;\n  box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.3);\n}\n\n.modal .btn-container,\n.task-modal .btn-container,\n.update-task-modal .btn-container {\n  align-self: center;\n  display: flex;\n  gap: 8px;\n}\n\n.modal .btn-container button,\n.task-modal .btn-container button,\n.update-task-modal .btn-container button {\n  color: var(--Background-color);\n  background-color: var(--Text-color);\n  outline: transparent;\n  border: 0;\n  min-width: 50px;\n  border-radius: 4px;\n  cursor: pointer;\n}\n\n.btn-container button:is(:hover, :focus) {\n  background-color: var(--Accent-color);\n}\n\n/* task container styles */\n\n.task {\n  background-color: var(--Background-color);\n  padding: 12px;\n  border-radius: 12px;\n  margin-bottom: 16px;\n}\n\n.task .task-header {\n  display: flex;\n  gap: 16px;\n}\n\n.task .task-header h3 {\n  margin-right: auto;\n}\n\n.task-header img {\n  width: 20px;\n  height: 20px;\n}\n\n.task-header h3,\n.task-header img {\n  cursor: pointer;\n}\n\n.task-due-date {\n  background-color: var(--Accent-color);\n  color: var(--Secondary-bg-color);\n  padding: 4px;\n  border-radius: 8px;\n}\n\n.task-priority {\n  color: var(--Secondary-bg-color);\n  padding: 4px;\n  border-radius: 8px;\n}\n\n.top {\n  background-color: var(--top-priority);\n}\n\n.medium {\n  background-color: var(--medium-priority);\n}\n\n.low {\n  background-color: var(--Base-color);\n}\n\n.task .task-details {\n  --spacer: 10px;\n  margin-block: var(--spacer);\n  display: none;\n  flex-direction: column;\n  align-items: center;\n}\n\n.task-details .task-btns-container {\n  display: flex;\n  justify-content: space-between;\n  gap: var(--spacer);\n  margin-block: var(--spacer);\n}\n\n.task-btns-container button {\n  min-width: 100px;\n  padding-block: 5px;\n  cursor: pointer;\n}\n\n.task-btns-container .edit-task-btn {\n  background-color: var(--Base-color);\n  opacity: 0.7;\n  color: var(--Background-color);\n  font-weight: 600;\n  outline: transparent;\n  border: 0;\n  border-radius: 8px;\n}\n\n.task-btns-container .remove-task-btn {\n  background-color: rgb(218 0 0);\n  opacity: 0.7;\n  color: var(--Background-color);\n  font-weight: 600;\n  outline: transparent;\n  border: 0;\n  border-radius: 8px;\n}\n\n.edit-task-btn:is(:hover, :focus),\n.remove-task-btn:is(:hover, :focus) {\n  opacity: 1;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,qBAAqB;EACrB,uBAAuB;EACvB,2BAA2B;EAC3B,6BAA6B;EAC7B,qBAAqB;EACrB,+BAA+B;EAC/B,wBAAwB;EACxB,mCAAmC;EACnC,uBAAuB;EACvB,0BAA0B;;EAE1B,0BAA0B;EAC1B,0BAA0B;AAC5B;;AAEA;;;EAGE,SAAS;EACT,sBAAsB;AACxB;;AAEA;EACE,iBAAiB;EACjB,aAAa;EACb,iCAAiC;EACjC,wBAAwB;EACxB,kBAAkB;AACpB;;AAEA;EACE,mCAAmC;EACnC,0BAA0B;EAC1B,wCAAwC;EACxC,yCAAyC;AAC3C;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,sBAAsB;EACtB,0BAA0B;AAC5B;;AAEA;EACE,yCAAyC;AAC3C;;AAEA;EACE,gBAAgB;EAChB,aAAa;EACb,6CAA6C;EAC7C,uBAAuB;EACvB,uCAAuC;AACzC;;AAEA;EACE,wCAAwC;AAC1C;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,SAAS;EACT,YAAY;EACZ,wCAAwC;EACxC,uCAAuC;EACvC,mBAAmB;EACnB,eAAe;AACjB;;AAEA;EACE,2CAA2C;AAC7C;AACA;EACE,2CAA2C;AAC7C;;AAEA;EACE,sCAAsC;EACtC,gCAAgC;EAChC,UAAU;EACV,gBAAgB;AAClB;;AAEA;EACE,sCAAsC;AACxC;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA,eAAe;AACf;EACE,iBAAiB;AACnB;;AAEA;EACE,wCAAwC;AAC1C;;AAEA;EACE,2CAA2C;EAC3C,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,UAAU;EACV,WAAW;EACX,mBAAmB;AACrB;;AAEA;EACE,sCAAsC;EACtC,8BAA8B;EAC9B,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,mBAAmB;EACnB,SAAS;EACT,sBAAsB;EACtB,YAAY;EACZ,mBAAmB;EACnB,eAAe;AACjB;;AAEA;EACE,sCAAsC;AACxC;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,kBAAkB;EAClB,wCAAwC;EACxC,yCAAyC;EACzC,mCAAmC;EACnC,0BAA0B;AAC5B;;AAEA;EACE,cAAc;AAChB;;AAEA;;;EAGE,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,gCAAgC;EAChC,aAAa;EACb,mCAAmC;EACnC,8BAA8B;EAC9B,kBAAkB;EAClB,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,mBAAmB;EACnB,2CAA2C;AAC7C;;AAEA;;;EAGE,kBAAkB;EAClB,aAAa;EACb,QAAQ;AACV;;AAEA;;;EAGE,8BAA8B;EAC9B,mCAAmC;EACnC,oBAAoB;EACpB,SAAS;EACT,eAAe;EACf,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,qCAAqC;AACvC;;AAEA,0BAA0B;;AAE1B;EACE,yCAAyC;EACzC,aAAa;EACb,mBAAmB;EACnB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,SAAS;AACX;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;;EAEE,eAAe;AACjB;;AAEA;EACE,qCAAqC;EACrC,gCAAgC;EAChC,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,gCAAgC;EAChC,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,qCAAqC;AACvC;;AAEA;EACE,wCAAwC;AAC1C;;AAEA;EACE,mCAAmC;AACrC;;AAEA;EACE,cAAc;EACd,2BAA2B;EAC3B,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,kBAAkB;EAClB,2BAA2B;AAC7B;;AAEA;EACE,gBAAgB;EAChB,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,mCAAmC;EACnC,YAAY;EACZ,8BAA8B;EAC9B,gBAAgB;EAChB,oBAAoB;EACpB,SAAS;EACT,kBAAkB;AACpB;;AAEA;EACE,8BAA8B;EAC9B,YAAY;EACZ,8BAA8B;EAC9B,gBAAgB;EAChB,oBAAoB;EACpB,SAAS;EACT,kBAAkB;AACpB;;AAEA;;EAEE,UAAU;AACZ","sourcesContent":[":root {\n  --Base-color: #36b37e;\n  --Accent-color: #ffc400;\n  --Background-color: #f3f5f7;\n  --Secondary-bg-color: #ffffff;\n  --Text-color: #333f50;\n  --Secondary-text-color: #9b9b9b;\n  --add-btn-color: #2d4acd;\n  --add-btn-hover: hsl(229, 80%, 30%);\n  --top-priority: #ef4040;\n  --medium-priority: #f08935;\n\n  --top-bottom-padding: 16px;\n  --right-left-padding: 16px;\n}\n\n*,\n*::before,\n*::after {\n  margin: 0;\n  box-sizing: border-box;\n}\n\nbody {\n  min-height: 100vh;\n  display: grid;\n  grid-template-rows: auto 1fr auto;\n  color: var(--Text-color);\n  position: relative;\n}\n\nheader {\n  background-color: var(--Base-color);\n  color: var(--Accent-color);\n  padding-block: var(--top-bottom-padding);\n  padding-inline: var(--right-left-padding);\n}\n\nh1 img {\n  width: 30px;\n  height: 28px;\n  vertical-align: middle;\n  color: var(--Accent-color);\n}\n\nmain {\n  background-color: var(--Background-color);\n}\n\nmain .content {\n  min-height: 100%;\n  display: grid;\n  grid-template-columns: minmax(120px, 20%) 1fr;\n  grid-template-rows: 1fr;\n  padding-left: var(--right-left-padding);\n}\n\nmain .side-bar {\n  padding-block: var(--top-bottom-padding);\n}\n\n.side-bar .wrapper {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 8px;\n  margin-bottom: var(--top-bottom-padding);\n  margin-right: var(--right-left-padding);\n  border-radius: 10px;\n  cursor: pointer;\n}\n\n.side-bar .wrapper:hover {\n  background-color: var(--Secondary-bg-color);\n}\n.side-bar .wrapper.active {\n  background-color: var(--Secondary-bg-color);\n}\n\n.side-bar #add-project {\n  background-color: var(--add-btn-color);\n  color: var(--Secondary-bg-color);\n  width: 60%;\n  font-weight: 600;\n}\n\n.side-bar #add-project:is(:hover, :focus) {\n  background-color: var(--add-btn-hover);\n}\n\n.wrapper h2 {\n  font-size: 18px;\n}\n\n.wrapper img {\n  width: 20px;\n  height: 20px;\n}\n\n/* close icon */\n.wrapper .close-icon {\n  margin-left: auto;\n}\n\n.projects h2 {\n  margin-bottom: var(--top-bottom-padding);\n}\n\nmain .main-content {\n  background-color: var(--Secondary-bg-color);\n  display: grid;\n  place-items: center;\n}\n\n.main-content .container {\n  width: 90%;\n  height: 90%;\n  margin-bottom: 32px;\n}\n\n.container .add-task {\n  background-color: var(--add-btn-color);\n  color: var(--Background-color);\n  font-size: 14px;\n  margin-block: 16px;\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  max-width: fit-content;\n  padding: 8px;\n  border-radius: 12px;\n  cursor: pointer;\n}\n\n.container .add-task:is(:hover, :focus) {\n  background-color: var(--add-btn-hover);\n}\n\n.container .add-task img {\n  width: 15px;\n  height: 15px;\n}\n\nfooter {\n  text-align: center;\n  padding-block: var(--top-bottom-padding);\n  padding-inline: var(--right-left-padding);\n  background-color: var(--Base-color);\n  color: var(--Accent-color);\n}\n\nfooter a {\n  color: inherit;\n}\n\n.modal,\n.task-modal,\n.update-task-modal {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  z-index: 9999;\n  background-color: var(--Base-color);\n  color: var(--Background-color);\n  padding: 16px 32px;\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n  border-radius: 12px;\n  box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.3);\n}\n\n.modal .btn-container,\n.task-modal .btn-container,\n.update-task-modal .btn-container {\n  align-self: center;\n  display: flex;\n  gap: 8px;\n}\n\n.modal .btn-container button,\n.task-modal .btn-container button,\n.update-task-modal .btn-container button {\n  color: var(--Background-color);\n  background-color: var(--Text-color);\n  outline: transparent;\n  border: 0;\n  min-width: 50px;\n  border-radius: 4px;\n  cursor: pointer;\n}\n\n.btn-container button:is(:hover, :focus) {\n  background-color: var(--Accent-color);\n}\n\n/* task container styles */\n\n.task {\n  background-color: var(--Background-color);\n  padding: 12px;\n  border-radius: 12px;\n  margin-bottom: 16px;\n}\n\n.task .task-header {\n  display: flex;\n  gap: 16px;\n}\n\n.task .task-header h3 {\n  margin-right: auto;\n}\n\n.task-header img {\n  width: 20px;\n  height: 20px;\n}\n\n.task-header h3,\n.task-header img {\n  cursor: pointer;\n}\n\n.task-due-date {\n  background-color: var(--Accent-color);\n  color: var(--Secondary-bg-color);\n  padding: 4px;\n  border-radius: 8px;\n}\n\n.task-priority {\n  color: var(--Secondary-bg-color);\n  padding: 4px;\n  border-radius: 8px;\n}\n\n.top {\n  background-color: var(--top-priority);\n}\n\n.medium {\n  background-color: var(--medium-priority);\n}\n\n.low {\n  background-color: var(--Base-color);\n}\n\n.task .task-details {\n  --spacer: 10px;\n  margin-block: var(--spacer);\n  display: none;\n  flex-direction: column;\n  align-items: center;\n}\n\n.task-details .task-btns-container {\n  display: flex;\n  justify-content: space-between;\n  gap: var(--spacer);\n  margin-block: var(--spacer);\n}\n\n.task-btns-container button {\n  min-width: 100px;\n  padding-block: 5px;\n  cursor: pointer;\n}\n\n.task-btns-container .edit-task-btn {\n  background-color: var(--Base-color);\n  opacity: 0.7;\n  color: var(--Background-color);\n  font-weight: 600;\n  outline: transparent;\n  border: 0;\n  border-radius: 8px;\n}\n\n.task-btns-container .remove-task-btn {\n  background-color: rgb(218 0 0);\n  opacity: 0.7;\n  color: var(--Background-color);\n  font-weight: 600;\n  outline: transparent;\n  border: 0;\n  border-radius: 8px;\n}\n\n.edit-task-btn:is(:hover, :focus),\n.remove-task-btn:is(:hover, :focus) {\n  opacity: 1;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   "createTaskInDom": () => (/* binding */ createTaskInDom),
/* harmony export */   "createUpdateTaskModal": () => (/* binding */ createUpdateTaskModal)
/* harmony export */ });
...
/* harmony import */ var _assets_project_img_svg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/project-img.svg */ "./src/assets/project-img.svg");
/* harmony import */ var _assets_close_small_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../assets/close-small-svgrepo-com.svg */ "./src/assets/close-small-svgrepo-com.svg");
/* harmony import */ var _assets_setting_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../assets/setting-svgrepo-com.svg */ "./src/assets/setting-svgrepo-com.svg");
/* harmony import */ var _assets_task_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../assets/task-svgrepo-com.svg */ "./src/assets/task-svgrepo-com.svg");
...
// create functions
const createProjectInDom = (title, projectId) => {
  const projectContainer = document.createElement('div');
  projectContainer.classList.add('wrapper');
  projectContainer.dataset.projectId = projectId;

  const projectIcon = document.createElement('img');
  projectIcon.src = _assets_project_img_svg__WEBPACK_IMPORTED_MODULE_0__;
  projectIcon.classList.add('.project-icon');
  const projectTitle = document.createElement('h3');
  projectTitle.textContent = title;
  const removeIcon = document.createElement('img');
  removeIcon.src = _assets_close_small_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_1__;
...
const createTaskInDom = (name, id, dueDate, priority, description) => {
  ...
  taskIcon.src = _assets_task_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_3__;
  ...
  taskSettingIcon.src = _assets_setting_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_2__;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "globalEventsHandler": () => (/* binding */ globalEventsHandler),
...
/* harmony import */ var _createUI__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createUI */ "./src/dom/createUI.js");
/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utilities */ "./src/dom/utilities.js");
...
const renderProjects = () => {
  ...
  projects.forEach((project) => {
    (0,_createUI__WEBPACK_IMPORTED_MODULE_1__.createProjectInDom)(project.title, project.id);
  });
};
...
const displayProjectModal = () => {
  displayModal('.modal', _createUI__WEBPACK_IMPORTED_MODULE_1__.createAddProjectModal);
};

const displayTaskModal = () => {
  displayModal('.task-modal', _createUI__WEBPACK_IMPORTED_MODULE_1__.createAddTaskModal);
};

const displayUpdateTaskModal = () => {
  displayModal('.update-task-modal', _createUI__WEBPACK_IMPORTED_MODULE_1__.createUpdateTaskModal);
};
...
const renderTasks = () => {
  ...
  if (sideBarOptionTitle === 'Inbox') {
    ...
    inbox.forEach((task) => {
      const taskTodo = (0,_createUI__WEBPACK_IMPORTED_MODULE_1__.createTaskInDom)(
        task.title,
        task.todoId,
        task.dueDate,
        task.priority,
  ...
  if (sideBarOptionTitle === 'Today') {
    const todayTasks = (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.getTodayTasks)();
  ...
  if (sideBarOptionTitle === 'This week') {
    const weekTasks = (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.getWeekTasks)();
...
const globalEventsHandler = (e) => {
  // Manage active states and switches of inbox, today and this week
  if (e.target.matches('.plan-items .wrapper')) {
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.switchSidebarOptions)('.plan-items .wrapper, [data-project-id]', e.target);
    renderTasks();
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.updatePriorityBg)();
  }
  if (e.target.matches('.plan-items .wrapper *')) {
    // added to make sure event will start if child element was pressed
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.switchSidebarOptions)(
  ...
  if (e.target.matches('#add-project') || e.target.matches('#add-project *')) {
    displayProjectModal();
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.resetModalInputs)('.modal');
  }
  ...
  if (e.target.matches('#add-btn')) {
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.addProject)();
    changeDisplay('.modal', 'none');
    renderProjects();
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.resetActiveSate)();
    renderTasks();
  }
  // Handle close icon events in project's div
  if (e.target.matches('.close-icon')) {
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.deleteProject)(e.target);
    renderProjects();
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.resetActiveSate)();
    renderTasks();
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.updatePriorityBg)();
  ...
  if (e.target.matches('.add-task, .add-task *')) {
    displayTaskModal();
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.resetModalInputs)('.task-modal');
    // updatePriorityBg();
  }
  ...
  if (e.target.matches('#add-task-btn')) {
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.addTask)();
    renderTasks();
  ...
  if (e.target.matches('.remove-task-btn')) {
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.deleteTask)(e.target);
    renderTasks();
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.updatePriorityBg)();
  }
  ...
  if (e.target.matches('.edit-task-btn')) {
    ...
    (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.fillUpdateTaskModal)(e.target);

    // Handle update edit task button
    const updateBtn = document.querySelector('#update-task-btn');
    updateBtn.addEventListener('click', () => {
      (0,_utilities__WEBPACK_IMPORTED_MODULE_2__.updateTask)(e.target);
      renderTasks();
...
/* harmony export */   "fillUpdateTaskModal": () => (/* binding */ fillUpdateTaskModal),
...
/* harmony export */   "resetActiveSate": () => (/* binding */ resetActiveSate),
/* harmony export */   "resetModalInputs": () => (/* binding */ resetModalInputs),
/* harmony export */   "switchSidebarOptions": () => (/* binding */ switchSidebarOptions),
/* harmony export */   "updatePriorityBg": () => (/* binding */ updatePriorityBg),
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/getISOWeek/index.js");
/* harmony import */ var _logic_logicController__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../logic/logicController */ "./src/logic/logicController.js");
...
// Utility functions
const resetModalInputs = (modalSelector) => {
...
const switchSidebarOptions = (selector, target) => {
...
const getTaskData = (listType, taskId) => {
  const data = [];
  if (listType === 'project') {
    const projects = (0,_logic_logicController__WEBPACK_IMPORTED_MODULE_0__.getProjectList)();
    projects.forEach((project) => {
...
const fillUpdateTaskModal = (target) => {
...
const getTodayTasks = () => {
  ...
  allTasks.forEach((task) => {
    const taskDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(task.dueDate);
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(taskDate, todayDate)) {
...
const getWeekTasks = () => {
  ...
  const currentWeekNumber = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date());
  allTasks.forEach((task) => {
    const taskWeekNumber = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(task.dueDate));
...
// render page
(0,_dom_displayController__WEBPACK_IMPORTED_MODULE_0__.renderProjects)();
(0,_dom_displayController__WEBPACK_IMPORTED_MODULE_0__.renderTasks)();

// events listeners
document.addEventListener('click', _dom_displayController__WEBPACK_IMPORTED_MODULE_0__.globalEventsHandler);

})();

/******/ })()
;
//# sourceMappingURL=bundle1df64170840fcd8d068c.js.map